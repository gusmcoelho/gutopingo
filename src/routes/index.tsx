...
const getPlans = (lang: Language): Plan[] => [
  ...
  },
  {
    ...
    price: lang === 'tr' ? "$ 40.00" : lang === 'pt' ? "R$ 20.00" : "$ 40.00",
    priceNote: lang === 'tr' ? "yaklaşık 1,834.10 TRY" : lang === 'pt' ? "acesso imediato" : "approx. R$ 200.00",
  ...
  },
  {
    ...
    price: lang === 'tr' ? "$ 90.00" : lang === 'pt' ? "R$ 45.00" : "$ 90.00",
    priceNote: lang === 'tr' ? "yaklaşık 4,126.70 TRY" : lang === 'pt' ? "acesso imediato" : "approx. R$ 450.00",
  ...
  },
  {
    ...
    price: lang === 'tr' ? "$ 200.00" : lang === 'pt' ? "R$ 100.00" : "$ 200.00",
    priceNote: lang === 'tr' ? "yaklaşık 9,170.50 TRY" : lang === 'pt' ? "acesso imediato" : "approx. R$ 1,000.00",
  ...
  },
  {
    ...
    price: lang === 'tr' ? "$ 340.00" : lang === 'pt' ? "R$ 169.99" : "$ 340.00",
    priceNote: lang === 'tr' ? "yaklaşık 15,589.10 TRY" : lang === 'pt' ? "PROMOÇÃO" : "approx. R$ 1,699.90",
